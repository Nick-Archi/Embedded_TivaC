...
/* --> PID_start */
extern xdc_Void PID_start(xdc_UArg);
...
const __T1_xdc_runtime_Text_charTab xdc_runtime_Text_charTab__A[6258];
 ...
 */
xdc__META(__ASM__, "@(#)__ASM__ = C:/TI_RTOS/Workspace/PWMRhem/Debug/configPkg/package/cfg/empty_pem4f");
...
ti_sysbios_family_arm_m3_Hwi_Object__ ti_sysbios_family_arm_m3_Hwi_Object__table__V[3] = {
    ...
    {/* instance#1 */
        0,
        ((xdc_UArg)(0x0)),  /* arg */
        ((xdc_Void(*)(xdc_UArg))((xdc_Fxn)PID_start)),  /* fxn */
        ((xdc_UArg)(0x3)),  /* irp */
...
__FAR__ const CT__xdc_runtime_Text_charCnt xdc_runtime_Text_charCnt__C = (xdc_Int16)0x1872;
...
#endif
#endif
const ti_sysbios_hal_Hwi_Handle timerInt = (ti_sysbios_hal_Hwi_Handle)((ti_sysbios_hal_Hwi_Handle)&ti_sysbios_hal_Hwi_Object__table__V[1]);
