...
.dlls,em4f .dlls: bluetooth.pem4f

-include package/cfg/bluetooth_pem4f.mak
-include package/cfg/bluetooth_pem4f.cfg.mak
ifeq (,$(MK_NOGENDEPS))
-include package/cfg/bluetooth_pem4f.dep
endif
bluetooth.pem4f: package/cfg/bluetooth_pem4f.xdl
	@


ifeq (,$(wildcard .libraries,em4f))
bluetooth.pem4f package/cfg/bluetooth_pem4f.c: .libraries,em4f
endif

package/cfg/bluetooth_pem4f.c package/cfg/bluetooth_pem4f.h package/cfg/bluetooth_pem4f.xdl: override _PROG_NAME := bluetooth.xem4f
package/cfg/bluetooth_pem4f.c: package/cfg/bluetooth_pem4f.cfg
package/cfg/bluetooth_pem4f.xdc.inc: package/cfg/bluetooth_pem4f.xdl
package/cfg/bluetooth_pem4f.xdl package/cfg/bluetooth_pem4f.c: .interfaces

clean:: clean,em4f
	-$(RM) package/cfg/bluetooth_pem4f.cfg
	-$(RM) package/cfg/bluetooth_pem4f.dep
	-$(RM) package/cfg/bluetooth_pem4f.c
	-$(RM) package/cfg/bluetooth_pem4f.xdc.inc

clean,em4f::
	-$(RM) bluetooth.pem4f
.executables,em4f .executables: bluetooth.xem4f

bluetooth.xem4f: |bluetooth.pem4f

-include package/cfg/bluetooth.xem4f.mak
bluetooth.xem4f: package/cfg/bluetooth_pem4f.oem4f 
	$(RM) $@
	@$(MSG) lnkem4f $@ ...
	$(RM) $(XDCCFGDIR)/$@.map
	$(ti.targets.arm.elf.M4F.rootDir)/bin/armcl -fs $(XDCCFGDIR)$(dir $@). -q -u _c_int00 --silicon_version=7M4 -z --strict_compatibility=on  -o $@ package/cfg/bluetooth_pem4f.oem4f   package/cfg/bluetooth_pem4f.xdl  -w -c -m $(XDCCFGDIR)/$@.map -l $(ti.targets.arm.elf.M4F.rootDir)/lib/libc.a
	
bluetooth.xem4f: export C_DIR=
bluetooth.xem4f: PATH:=$(ti.targets.arm.elf.M4F.rootDir)/bin/;$(PATH)
bluetooth.xem4f: Path:=$(ti.targets.arm.elf.M4F.rootDir)/bin/;$(PATH)

bluetooth.test test,em4f test: bluetooth.xem4f.test

bluetooth.xem4f.test:: bluetooth.xem4f
ifeq (,$(_TESTLEVEL))
	@$(MAKE) -R -r --no-print-directory -f $(XDCROOT)/packages/xdc/bld/xdc.mak _TESTLEVEL=1 bluetooth.xem4f.test
else
	@$(MSG) running $<  ...
	$(call EXEC.bluetooth.xem4f, ) 
endif

clean,em4f::
	-$(RM) $(wildcard .tmp,bluetooth.xem4f,*)
...
%,copy:
	...
	$(RM) $@
	$(CP) $< $@
bluetooth_pem4f.oem4f,copy : package/cfg/bluetooth_pem4f.oem4f
bluetooth_pem4f.sem4f,copy : package/cfg/bluetooth_pem4f.sem4f
