...
float integral = 0;
float output;
float sampleTime = 5 * (10^-5); // microseconds
float distFrt;
float distRt;
int outMax; // max output on PWM
int outMin; // min output on PWM
char frontDist [7];
char rightDist [7];
char outputCal [20];
int max = 150;
...
//            integral=500;
//        float derivative = (error-lastErr)/.050;
...
/*
 * Min -> Minimum clamped value == -1000
 * Max -> Maximum clamped value == 1000
 */
