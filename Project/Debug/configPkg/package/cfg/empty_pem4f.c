...
const __T1_xdc_runtime_Text_charTab xdc_runtime_Text_charTab__A[6248];
 ...
 */
xdc__META(__ASM__, "@(#)__ASM__ = C:/TI_RTOS/TM4C/Labs/Lab_05/Project/Debug/configPkg/package/cfg/empty_pem4f");
...
__FAR__ const CT__xdc_runtime_Text_charCnt xdc_runtime_Text_charCnt__C = (xdc_Int16)0x1868;
